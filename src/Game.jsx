...
const initialWorldState = {
  ...
  npcs: [
    ...
    withDialogueDefaults({
      id: "npc_5",
      name: "Aldous Penmark",
      title: "the Cartographer",
      gender: "male",
      roles: ["cartographer", "traveler"],
      memory: "An unaffiliated cartographer who has spent decades mapping all seven regions on foot. His maps sometimes show details that do not exist yet but later come true, for reasons even Aldous does not understand.",
      influenceWeight: 3,
    }),
    withDialogueDefaults({
      id: "npc_6",
      name: "Ser Colwyn Ashe",
      title: "the defrocked Warden",
      roles: ["traveler", "former_warden"],
      memory: "A wandering, unaffiliated former member of the Heartlands' Wardens of the Light, excommunicated for asking the wrong questions about how the Faith selects its Lumenant.",
      personalAxes: { compassion: 30, honesty: 70, diplomacy: -20 },
      influenceWeight: 2,
    }),
    withDialogueDefaults({
      id: "npc_7",
      name: "Elenya Rootsworn",
      title: "the renegade Rootwarden",
      roles: ["renegade", "former_rootwarden"],
      memory: "A Forest-born renegade who left the Sern Circle's Rootwarden order. Her departure is quietly significant: Rootwardens keep the Undersong flowing for every caster on the continent, not only Elves, though almost no one—including the player—has any way to know this yet.",
      narrativeNote: "Signature mechanic (a value-for-a-price bargain where the price is her choice, not conventional worth) is NOT implemented in this task — narrative record only.",
      influenceWeight: 1,
    }),
    withDialogueDefaults({
      id: "npc_8",
      name: "Clan Skarrow Messenger",
      roles: ["messenger", "information_broker"],
      memory: "A genuinely neutral Tundra messenger and natural information-broker, shaped by Clan Skarrow's structurally neutral, non-hereditary leadership.",
      factionId: "skarrow",
      influenceWeight: 1,
    }),
    withDialogueDefaults({
      ...
      roles: ["healer", "traveler"],
      memory: "An unaffiliated healer with no official standing anywhere. They have treated an unusual illness in the Swamp and unusually severe frostbite in the Tundra without connecting the two.",
      influenceWeight: 1,
    }),
  ],
